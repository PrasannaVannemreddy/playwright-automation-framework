...
const GMAIL_USER = { email: "lakshmi.itqa@gmail.com", password: "QATester@9" };
...
test("refund eligible for single ticket booking", async ({ page }) => {
  ...
  await page.getByLabel("Full Name").fill("prasanna");
  await page.locator("#customer-email").fill(GMAIL_USER.email);
  await page.getByPlaceholder("+91 98765 43210").fill("8897555052");
